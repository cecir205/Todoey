...
class TodoListViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
       ...
       // itemArray.remove(at: indexPath.row)
        ...
        itemArray[indexPath.row].done = !itemArray[indexPath.row].done // check/uncheck
        
        self.saveItems() // persistent container
    ...
    func loadItems(with request: NSFetchRequest<Item> = Item.fetchRequest(), predicate : NSPredicate? = nil){ // function with default value!
